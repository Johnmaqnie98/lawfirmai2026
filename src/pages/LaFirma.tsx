...
const teamCategories: { label: string; members: TeamMemberType[] }[] = [
  ...
  },
  {
    ...
    members: [
      ...
      {
        name: 'Jhonatan Sánchez',
        role: 'Director de Inteligencia Artificial, Automatización y Gobernanza Tecnológica',
        category: 'Gerente',
        brief: 'Fundador y Director General de INTELLEXIA Industries. Especialista en arquitectura de inteligencia artificial, automatización empresarial, sistemas agentivos y gobernanza tecnológica. Es Regional Lead de la Young AI Leaders Community de AI for Good, iniciativa organizada por la Unión Internacional de Telecomunicaciones, agencia especializada de las Naciones Unidas para las tecnologías digitales.',
        bio: 'Jhonatan Sánchez es fundador y Director General de INTELLEXIA Industries, firma mexicana especializada en el diseño e implementación de infraestructura de inteligencia artificial, automatización empresarial, sistemas agentivos y soluciones de software.\n\nSu trabajo se centra en convertir la inteligencia artificial en infraestructura operativa: sistemas capaces de organizar conocimiento, automatizar procesos, fortalecer la toma de decisiones y mejorar el control institucional. Ha liderado iniciativas para organizaciones de alcance nacional, instituciones educativas, firmas profesionales y empresas de sectores como servicios jurídicos, bienes raíces, salud, telecomunicaciones y administración pública.\n\nActualmente forma parte del programa AI for Good de las Naciones Unidas como Regional Lead de la Young AI Leaders Community, desde el Mexico City Hub para la región de las Américas. AI for Good es organizado por la Unión Internacional de Telecomunicaciones, agencia especializada de las Naciones Unidas para las tecnologías digitales, y articula la participación de gobiernos, industria, academia, sociedad civil y organismos internacionales para promover el desarrollo responsable de la inteligencia artificial.\n\nCuenta con experiencia en desarrollo de negocios, estrategia comercial y transformación tecnológica. Su enfoque integra inteligencia artificial, gobernanza de datos, cumplimiento normativo, diseño organizacional y automatización de procesos para construir sistemas escalables, auditables y alineados con los objetivos estratégicos de cada institución.\n\nHa participado en iniciativas nacionales e internacionales relacionadas con adopción responsable de inteligencia artificial, educación tecnológica, innovación institucional y colaboración entre empresas, gobierno y academia.\n\nDentro de la Firma dirige la práctica de Inteligencia Artificial, Automatización y Gobernanza Tecnológica, apoyando a clientes en el diagnóstico, diseño e implementación de estrategias de adopción de IA, automatización, cumplimiento tecnológico y transformación organizacional.',
      },
      {
        name: 'Daniel Mancilla Velázquez',
        role: 'Gerente de Monitoreo Legislativo y Cabildeo Político',
        category: 'Gerente',
        brief: 'Especialista en asuntos públicos, regulación y relacionamiento gubernamental, con enfoque en los sectores de energía y tecnología. Experiencia en Intellexia Industries, Holland & Knight y el Senado de la República.',
        bio: 'Profesional en asuntos públicos y regulación, especializado en relacionamiento estratégico con autoridades y análisis del entorno político-regulatorio en sectores como energía, tecnología y bienes de consumo. Actualmente es Head of Government Affairs and Institutional Relations en Intellexia Industries, donde lidera las relaciones gubernamentales e institucionales de la empresa y la vinculación con autoridades, academia y organismos nacionales e internacionales. Previamente se desempeñó como Asistente Legislativo en Holland & Knight y en la LXIV Legislatura del Congreso de la Unión (Senado de la República), donde participó en la redacción de iniciativas de ley y el análisis legislativo en ciberseguridad, inteligencia artificial y tecnologías emergentes. Fue Miembro del Consejo de Expertos de la Alianza Nacional de Inteligencia Artificial (ANIA) y actualmente es Impact Lead del Young AI Leaders Mexico City Hub, iniciativa de AI for Good.\n\nEs Licenciado en Gobierno y Licenciado en Economía por la Universidad Panamericana, cuenta con un Diplomado de Especialización en Gobierno de Instituciones y Organismos Internacionales por el Centro Universitario Villanueva (España) y con la Certificación Profesional Chief AI Officer (CAIO-PMTM), Nivel Asociado, por Silicon Valley Certification Hub.',
      },
    ],
  },
];
